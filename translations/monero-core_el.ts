...
<context>
    ...
    <message>
        ...
        <translation>Αυτό διευκολύνει την αποστολή ή λήψη του Tuske και μειώνει τα σφάλματα κατά τη χειροκίνητη πληκτρολόγηση διευθύνσεων.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>ΠΡΟΣΟΧΗ: Μην επαναχρησιμοποιείτε τα κλειδιά του Tuske σε άλλη διακλάδωση, ΕΚΤΟΣ κι αν αυτή η διακλάδωση έχει ενσωματωμένο μετριασμό επαναχρησιμοποίησης κλειδιού . Κάνοντας το αυτό θα βλάψει την ιδιωτικότητα σας.</translation>
    </message>
    <message>
        ...
        <translation>ΠΡΟΣΟΧΗ: Αντιγράφοντας την φράση σας στο πρόχειρο μπορεί να σας εκθέσει σε κακόβουλο λογισμικό, το οποίο μπορεί να καταγράψει την φράση σας και να κλέψει τα Tuske σας. Παρακαλώ γράψτε την φράση σας χειροκίνητα.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Ενσωματωμένη έκδοση Tuske: </translation>
    </message>
    <message>
...
Το παλιό αρχείο προσωρινής μνήμης πορτοφολιού θα μετονομαστεί και μπορεί να αποκατασταθεί αργότερα.
    ...
    <message>
        ...
        <translation>Κάντε δωρεά στο Tuske</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Χρησιμοποιεί διακομιστή από τρίτο πάροχο για τη σύνδεση στο δίκτυο του Tuske. Λιγότερο ασφαλές, αλλά ελαφρύτερο για τον υπολογιστή σας.</translation>
    </message>
    <message>
        ...
        <translation>Για την εύρεση απομακρυσμένου κόμβου, πληκτρολογήστε &apos;Tuske remote node&apos; στην αγαπημένη σας μηχανή αναζήτησης. Παρακαλώ διαβεβαιώστε πως ο κόμβος λειτουργεί μέσω αξιόπιστου τρίτου παρόχου.</translation>
    </message>
    <message>
...
Μπορείτε να αλλάξετε τον κωδικό πρόσβασης στις ρυθμίσεις πορτοφολιού.</translation>
    ...
    <message>
        ...
        <translation>Λάβετε Tuske για την επιχείρηση σας με ευκολία.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Αυτή η σελίδα σας επιτρέπει την αλληλεπίδραση με την κοινόχρηστη βάση δεδομένων δαχτυλιδιού. Αυτή η βάση δεδομένων προορίζεται για χρήση στα πορτοφόλια του Tuske, όπως και κλώνους του, οι οποίοι επαναχρησιμοποιούν τα κλειδιά του Μonero.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Για να αποκρύψετε ποιες είσοδοι ξοδεύονται σε μια συναλλαγή Tuske, ένας τρίτος δεν πρέπει να είναι σε θέση να ξεχωρίσει το ποιες είσοδοι είναι ήδη γνωστό ότι δαπανώνται σε έναν δακτύλιο. Το να μπορεί να γίνει αυτό θα εξασθενίσει την προστασία που παρέχεται από τις υπογραφές του δακτυλίου. Εάν είναι γνωστό ότι έχουν ήδη δαπανηθεί όλες εκτός από μία από τις εισόδους, τότε η είσοδος που ξοδεύεται στην πραγματικότητα γίνεται εμφανής, ακυρώνοντας έτσι την επίδραση των υπογραφών του δακτυλίου, ένα από τα τρία βασικά επίπεδα προστασίας της ιδιωτικότητας που χρησιμοποιεί το Tuske. &lt;br&gt;Για να βοηθήσετε τις συναλλαγές να αποφύγουν αυτές τις εισροές, μια λίστα γνωστών δαπανών μπορεί να χρησιμοποιηθεί για να αποφευχθεί η χρήση τους σε νέες συναλλαγές. Μια τέτοια λίστα διατηρείται από το Tuske και είναι διαθέσιμη στον ιστότοπο tuske.network και μπορείτε να εισάγετε αυτήν τη λίστα εδώ. &lt;br&gt;Εναλλακτικά, μπορείτε να σαρώσετε μόνοι σας το blockchain (και τα blockchain των κλώνων Tuske που επαναχρησιμοποιούν κλειδιά) με το εργαλείο tuske-blockchain-mark-spent-outputs για τη δημιουργία μιας λίστας γνωστών εξαγόμενων δαπανών.&lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Προκειμένου να αποφευχθεί η ακύρωση της προστασίας που παρέχεται από τις υπογραφές δακτυλίων του Tuske, μια έξοδος δεν πρέπει να δαπανάται με διαφορετικούς δακτυλίους σε διαφορετικά blockchain. Αν και αυτό συνήθως δεν προκαλεί ανησυχία, μπορεί να προκαλέσει όταν ο κλώνος Tuske που επαναχρησιμοποιεί τα κλειδιά, σας επιτρέπει να ξοδέψετε υπάρχουσες εξόδους. Σε αυτήν την περίπτωση, πρέπει να διασφαλίσετε ότι η υπάρχουσα έξοδος χρησιμοποιεί τον ίδιο δακτύλιο και στις δύο αλυσίδες. &lt;br&gt;Αυτό θα γίνει αυτόματα από το Tuske και από οποιοδήποτε λογισμικό επαναχρησιμοποίησης κλειδιών που δεν προσπαθεί να αφαιρέσει ενεργά το απόρρητό σας. &lt;br&gt;Εάν χρησιμοποιείτε και έναν κλώνο Tuske που επαναχρησιμοποιεί κλειδιά και αυτός ο κλώνος δεν περιλαμβάνει αυτήν την προστασία, μπορείτε ακόμα να διασφαλίσετε ότι οι συναλλαγές σας προστατεύονται δαπανώντας πρώτα στον κλώνο και, στη συνέχεια, προσθέτοντας χειροκίνητα τον δακτύλιο σε αυτήν τη σελίδα, όπου σας επιτρέπει να ξοδέψετε το Tuske σας με ασφάλεια. &lt;br&gt;Εάν δεν χρησιμοποιείτε κλώνο Tuske που επαναχρησιμοποιεί κλειδιά χωρίς αυτά τα χαρακτηριστικά ασφαλείας, τότε δεν χρειάζεται να κάνετε τίποτα, καθώς όλα είναι αυτοματοποιημένα.&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>Αυτό καταγράφει δακτυλίους που χρησιμοποιούνται από εξόδους που δαπανήθηκαν στο Tuske σε μια αλυσίδα επαναχρησιμοποίησης κλειδιών, έτσι ώστε ο ίδιος δακτύλιος να μπορεί να επαναχρησιμοποιηθεί για να αποφευχθούν ζητήματα απορρήτου.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Εισάγετε την Διεύθυνση Tuske (παράδειγμα: 44AFFq5kSiGBoZ...)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Διαθέσιμο κεφάλαιο: %1 TSK. Παρακαλώ περιμένετε ~%2 λεπτά για να γίνει διαθέσιμο ολόκληρο το υπόλοιπο σας.</translation>
    </message>
    <message>
...
Confirmation message:
    ...
    <message>
        ...
        <translation>Επιτυχής αποστολή Tuske</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Διεύθυνση Tuske</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>H νέα έκδοση του Tuske v%1 είναι διαθέσιμη.</translation>
    </message>
    <message>
        <location filename="../components/UpdateDialog.qml" line="98"/>
        <source>Please visit tuske.network for details</source>
        <translation>Για λεπτομέρειες παρακαλώ επισκεφτείτε το tuske.network</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Για να μπορείτε να επικοινωνείτε με το δίκτυο Tuske, το πορτοφόλι σας πρέπει να είναι συνδεδεμένο σε κόμβο Tuske. Για καλύτερο απόρρητο, συνιστάται να τρέξετε τον δικό σας κόμβο.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Επιπλέον, μπορείτε να καθορίσετε έναν κόμβο εκκίνησης για άμεση χρήση του Tuske.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Καλώς ήλθατε στο Tuske</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Κάντε αυτή την επιλογή εάν είναι η πρώτη φορά που χρησιμοποιείτε το Tuske.</translation>
    </message>
    <message>
        <location filename="../wizard/WizardHome.qml" line="104"/>
    ...
    <message>
        ...
        <translation>Συνδέστε το υλικό πορτοφόλι σας για την δημιουργία ενός νέου πορτοφολιού Tuske.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Η προσωρινή χρήση απομακρυσμένων κόμβων είναι σημαντική για άμεση χρήση του Tuske (εξ ου και το όνομα bootstrap), ωστόσο να γνωρίζετε ότι όταν χρησιμοποιείτε απομακρυσμένους κόμβους (συμπεριλαμβανομένης της ρύθμισης bootstrap), οι κόμβοι θα μπορούσαν να παρακολουθούν τη διεύθυνση IP σας, να παρακολουθούν το &quot;ύψος επαναφοράς&quot; και συσχετισμένα δεδομένα αιτήματος block και να σας στείλουνε ανακριβείς πληροφορίες για να μάθουνε περισσότερα σχετικά με τις συναλλαγές που πραγματοποιείτε.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Αυτή η λειτουργία είναι ιδανική για τη διαχείριση μικρών ποσών Tuske. Έχετε πρόσβαση σε βασικές δυνατότητες για την πραγματοποίηση και διαχείριση συναλλαγών. Θα συνδεθεί αυτόματα στο δίκτυο Tuske, ώστε να ξεκινήσετε να χρησιμοποιείτε το Tuske αμέσως.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Δημιουργήστε φορητά πορτοφόλια και χρησιμοποιήστε τα σε οποιονδήποτε υπολογιστή. Ενεργοποιήστε εάν εγκαταστήσατε το Tuske σε USB στικάκι, εξωτερική μονάδα δίσκου ή σε οποιοδήποτε άλλο φορητό μέσο αποθήκευσης.</translation>
    </message>
    <message>
...
If you don&apos;t have the option to run your own node, there&apos;s an option to connect to a remote node.</source>
        <translation>Για να μπορείτε να επικοινωνείτε με το δίκτυο Tuske, το πορτοφόλι σας πρέπει να είναι συνδεδεμένο σε κόμβο Tuske. Για καλύτερο απόρρητο, συνιστάται να τρέξετε τον δικό σας κόμβο.
...
<context>
    ...
    <message>
        ...
        <translation>Αυτή η διεύθυνση έλαβε %1 tuske, με %2 επιβεβαιώση(-σεις).</translation>
    </message>
    <message>
        <location filename="../main.qml" line="1066"/>
        <source>Good signature</source>
    ...
    <message>
        ...
        <translation>Θα θέλατε να εγγραφείτε στην καταχώρηση Γραφικού Περιβάλλοντος Χρήστη του Tuske Desktop;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Αυτή η διεύθυνση έλαβε %1 tuske, αλλά η συναλλαγή δεν έχει εξορυχθεί ακόμα</translation>
    </message>
    <message>
