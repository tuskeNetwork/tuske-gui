...
<context>
    ...
    <message>
        ...
        <translation>Це полегшує надсилання та отримання Tuske і знижує кількість помилок при введенні адрес вручну.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>ПОПЕРЕДЖЕННЯ: Не використовуйте повторно свої ключі Tuske в іншому форку, ЯКЩО ТІЛЬКИ цей форк не має вбудованих засобів захисту від компрометації введених ключів. Подібні дії можуть зашкодити вашій конфіденційності.</translation>
    </message>
    <message>
        ...
        <translation>УВАГА: Копіювання вашої мнемонічної фрази в буфер обміну може супроводжуватися перехопленням цих даних різним шкідливим програмним забезпеченням, яке відправить вашу мнемоніку зловмисникові, після чого ваші Tuske можуть бути вкрадені. Будь ласка, введіть вашу мнемонічну фразу вручну з клавіатури.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Вбудована версія Tuske: </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Використовувати сторонній вузол для підключення до мережі Tuske. Менш безпечно, але більш зручно.</translation>
    </message>
    <message>
        ...
        <translation>Щоб отримати список віддалених нод, введіть &apos;Tuske remote node&apos; у вашій улюбленій пошуковій системі. Будь ласка, переконайтеся, що обраній ноді можна довіряти.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>На цій сторінці можна взаємодіяти із загальною базою даних RingDB. Ця база даних призначена для використання гаманцями Tuske або їх клонів, які зможуть повторно використовувати ключі Tuske.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Для того щоб приховати які входи в транзакціях Tuske були витрачені, третя сторона не повинна повідомляти які входи в кільці вже задіяні в витраті. Адже якщо це зробити, то це послабить захист, який забезпечується кільцевими підписами. Якщо відомо, що всі, крім одного з входів, вже витрачені, то фактично трата входу стає очевидною, тим самим анулюється ефект кільцевих підписів, одного з трьох основних рівнів захисту конфіденційності Tuske.&lt;br&gt;Щоб допомогти транзакціям уникнути витрати цих входів, можна використовувати список відомих витрачених входів, щоб уникнути їх використання в нових транзакціях. Такий список підтримується проектом Tuske і доступний на веб-сайті tuske.network, і ви можете імпортувати цей список тут.&lt;br&gt;Крім того, ви можете просканувати блокчейн (і блокчейни клонів Tuske) самостійно, використовуючи інструмент tuske-blockchain-mark-spent-outputs, щоб створити список відомих витрачених входів.&lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Щоб уникнути скасування захисту, що забезпечується кільцевими підписами Tuske, вихід не повинен проводитися з різними кільцями на різних блокчейнах. Хоча це як правило не викликає занепокоєння, він може стати одним, якщо якийсь клон Tuske, що використовує ключ повторно, дозволяє вам витрачати існуючі виходи. В цьому випадку вам необхідно забезпечити, щоб ці існуючі виходи використовували одне і те ж кільце для обох блокчейнів.&lt;br&gt;Це може бути зроблено автоматично, або будь-яким програмним забезпеченням з можливістю повторного використання ключів, яке не спробує позбавити вас конфіденційності.&lt;br&gt;Якщо ви використовуєте клон Tuske з повторним використанням ключа, і цей клон не включає цей захист, ви все одно можете гарантувати, що ваші транзакції будуть захищені, зробивши їх спочатку на клоні, потім вручну додати кільце на цій сторінці, що дозволить вам конфіденційно перевести ваші Tuske.&lt;br&gt;Якщо ви не використовуєте клон Tuske з повторним використанням ключів без цих функцій безпеки, то вам не потрібно нічого робити, оскільки все автоматизовано.&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>Тут записуються кільця, що використовуються виходами проведеними на Tuske, так що одне і те ж кільце можна використовувати повторно, щоб уникнути проблем з конфіденційністю.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введіть адресу Tuske (наприклад: 44AFFq5kSiGBoZ...)</translation>
    </message>
    <message>
...
Confirmation message:
    ...
    <message>
        ...
        <translation>Tuske відправлено успішно</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Щоб мати можливість обмінюватися даними з мережею Tuske, ваш гаманець повинен бути підключений до ноди Tuske. Для кращої конфіденційності рекомендується запустити свою власну ноду.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Окрім цього, ви можете вказати ноду швидкого завантаження, щоб негайно почати користуватися Tuske.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Виберіть цю опцію, якщо ви вперше користуєтесь Tuske.</translation>
    </message>
    <message>
        <location filename="../wizard/WizardHome.qml" line="104"/>
...
<context>
    ...
    <message>
        ...
        <translation>Тимчасове використання віддалених нод зручно для негайного використання Tuske (звідси назва &quot;початкове завантаження&quot;), однак пам&apos;ятайте, що при використанні віддалених нод (включаючи вибір початкового завантаження), ноди можуть відстежувати вашу IP адресу, відстежувати вашу &quot;висоту відновлення&quot; і відповідні дані запиту блоку, і відправляти вам неточну інформацію, щоб дізнатися більше про здійснені вами транзакції.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Цей режим ідеально підходить для управління невеликими сумами Tuske. У вас є доступ до основних функцій для здійснення транзакцій та управління ними. Програма автоматично підключиться до мережі Tuske, щоб ви відразу могли почати використовувати Tuske.</translation>
    </message>
    <message>
...
If you don&apos;t have the option to run your own node, there&apos;s an option to connect to a remote node.</source>
        <translation>Щоб мати можливість обмінюватися даними з мережею Tuske, ваш гаманець повинен бути підключений до ноди Tuske. Для кращої конфіденційності рекомендується запустити свою власну ноду.
...
<context>
    ...
    <message>
        ...
        <translation>Цей адрес отримав %1 TSK, із %2 підтвердженням(и).</translation>
    </message>
    <message>
        <location filename="../main.qml" line="1066"/>
        <source>Good signature</source>
    ...
    <message>
        ...
        <translation>Цей адрес отримав %1 TSK, але транзакція ще не була підтверджена майнерами</translation>
    </message>
    <message>
