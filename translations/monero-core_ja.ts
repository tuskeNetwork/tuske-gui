...
<context>
    ...
    <message>
        ...
        <translation>Tuskeを送ったり受け取ったりするのが簡単になり、アドレスを手で打ち間違えるのを避けられます。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>警告: キーの再利用に関する対策が組み込まれていない限り、Tuskeのキーを別のフォークで使い回さないでください。あなたのプライバシーが損なわれます。</translation>
    </message>
    <message>
        ...
        <translation>警告: シードをクリップボードにコピーすると、シードを記録しTuskeを盗む悪意あるソフトウェアに晒される可能性があります。シードは手で書き留めてください。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>組み込まれているTuskeのバージョン: </translation>
    </message>
    <message>
...
古いウォレットのキャッシュはリネームされ後で復元できます。
    ...
    <message>
        ...
        <translation>Tuskeに寄付</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>サードパーティーのサーバを使ってTuskeネットワークに接続します。セキュリティは低くなりますがより簡単です。</translation>
    </message>
    <message>
        ...
        <translation>リモートノードを見つけるには、お好きな検索エンジンで&apos;Tuske remote node&apos;と検索してください。ノードが信頼できるサードパーティーによって運営されていることを確認してください。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>このページでは共有リングデータベースを操作できます。このデータベースはTuskeウォレットおよびTuskeのキーを再利用するTuskeクローンのウォレットで利用するためのものです。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>第三者がリング内に既知の使用済みインプットを見つけられないことは、Tuskeトランザクションのどのインプットが使用されたのかを隠すために必要です。もし見つけられるとリング署名による保護は弱まります。もし1つのインプットを除いてすべてが使用済みだと知られている場合、実際に使用されたインプットは明らかとなり、Tuskeが使っている3つの主要なプライバシー保護レイヤーのうちの1つであるリング署名の効果が失われてしまいます。&lt;br&gt;トランザクションでそれらのインプットを避けるため、既知の使用済みインプットのリストを用いてそれらを新規のトランザクションで使用しないようにできます。このようなリストはTuskeプロジェクトによって保守されtuske.networkのウェブサイトで公開されており、ここではこのリストをインポートすることができます。&lt;br&gt;あるいはtuske-blockchain-mark-spent-outputsというツールを使い、Tuskeのブロックチェーン(およびキーを再利用するTuskeクローンのブロックチェン)を自分でスキャンして既知の使用済みアウトプットのリストを生成できます。&lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Tuskeのリング署名による保護を無効化しないため、あるアウトプットを使う際に異なるブロックチェーンで異なるリングを使うことは避けなければなりません。これは通常問題になりませんが、キーを再利用するTuskeクローンが既存のアウトプットの使用を許している場合問題になります。この場合、既存のアウトプットは両方のチェーンで同じリングを使わなくてはなりません。&lt;br&gt;これはキーを再利用するソフトウェアが積極的にプライバシーを侵害しようとしない限り自動的に行われます。&lt;br&gt;もしキーを再利用するTuskeクローンを使っていてそのクローンがこの保護を含んでいない場合も、まずクローンの方でアウトプットを使用しその後リングをこのページに手動で追加することで、トランザクションは保護されTuskeを安全に使用できるようになります。&lt;br&gt;これらの機能を提供しないキーを再利用するTuskeクローンを使用していない場合、すべては自動化されているので何もする必要はありません。&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>キーを再利用するチェーンでアウトプットに使用されたリングを記録し、プライバシーの問題を避けるためTuskeでも同じリングを使うようにします。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Tuskeアドレス (例: 44AFFq5kSiGBoZ...)</translation>
    </message>
    <message>
...
Confirmation message:
    ...
    <message>
        ...
        <translation>Tuskeの送金に成功しました</translation>
    </message>
    <message>
...
アップグレードするか別のデーモンに接続してください</translation>
    ...
    <message>
        ...
        <translation>支出可能な資金: %1 TSK. 全ての残高が利用可能になるまで~%2分ほどお待ちください。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>TSKをコールド(オフライン)ウォレットから消費する</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>tuske.networkを訪問して詳細を確認してください</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>TuskeネットワークとやりとりするにはウォレットをTuskeノードに接続する必要があります。プライバシーのためにはあなた自身がノードを走らせることを推奨します。</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Tuskeをすぐに使いたい場合ブートストラップノードを指定できます。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>もしTuskeを使うのが初めてならこのオプションを選んでください。</translation>
    </message>
    <message>
        <location filename="../wizard/WizardHome.qml" line="104"/>
    ...
    <message>
        ...
        <translation>ハードウェアウォレットを接続して新しいTuskeウォレットを作成。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Tuskeをもうすぐ使いに初めにリモートノードの利用はいいですがリモートノードの使う時に他の人はアドレスを追跡し、復元を開始するブロック高を洞察し、不正確な情報を送信することで、あなたの取引の詳細をもっと洞察できますよ。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>このモードは少額のTuskeを扱う場合に適しています。取引を作成したり管理したりする基本的な機能にアクセスできます。Tuskeネットワークに自動的に接続するためTuskeをすぐに使い始めることができます。</translation>
    </message>
    <message>
...
If you don&apos;t have the option to run your own node, there&apos;s an option to connect to a remote node.</source>
        <translation>TuskeネットワークとやりとりするためウォレットはTuskeノードに接続する必要があります。プライバシーのため自分自身でノードを走らせることを推奨します。
...
<context>
    ...
    <message>
        ...
        <translation>このアドレスは%1TSKを受け取りましたが、取引はまだ承認されていません</translation>
    </message>
    <message>
        <location filename="../main.qml" line="1055"/>
        <source>This address received %1 tuske, with %2 confirmation(s).</source>
        <translation>このアドレスは%1TSKを受け取り、その取引は%2回承認されました。</translation>
    </message>
    <message>
