...
<context>
    ...
    <message>
        ...
        <translation>这会使发送或接收Tuske更加简单，并且减少在手动输入地址时发生的错误。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>警告：请勿在别的分叉上重用你的 Tuske 私钥，除非这个分叉内置了重用保护，否则隐私会受到侵害。</translation>
    </message>
    <message>
        ...
        <translation>警告：复制种子单词到剪贴板，可能会暴露给恶意软件，导致你的种子单词被记录，从而Tuske被盗。请手工抄写下这些种子单词。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>内置 Tuske 版本：</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>使用一个第三方的服务器连接到 Tuske 网络。安全性较低，但更加轻便。</translation>
    </message>
    <message>
        ...
        <translation>可以在搜索引擎中查找“Tuske 远程节点”。请注意确保节点由一个可信任的第三方维护。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>为了掩盖Tuske交易中任何付款的去向，第三方不应知道环签名中每个输入和输出的对应关系。否则就会削弱环签名提供的保护作用。如果仅有一个输入之外的所有输入都已知，那么所有付款的去向将变得透明，这将使作为门罗币三个主要隐私保护层之一的环签名彻底无效。&lt;br&gt; 为帮助交易中避免出现这些问题，可以使用已知去向交易清单来避免在新交易中使用它们。这个清单由门罗币项目维护，可在 tuske.network 网站上找到，您可以在此处导入此清单。 &lt;br&gt; 或者您可以自己扫描区块链 （以及复制了门罗币密钥的克隆钱包的区块链），使用tuske-blockchain-mark-spent-outputs 工具创建已知的已用输出清单。 &lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>为避免 Tuske 环签名所提供的保护被破坏，某个输出不应在别的链上与别的成员结成一个新环而被再次花费掉（这样会导致产生相同的 key image）。尽管这看上去不是什么问题，但当一个重用密钥的 Tuske 拷贝可以让你重新消费已被消费的输出时，这是个大问题。这里，你必须保证这个已存在的输出在两条链上使用了相同的环。&lt;br&gt;Tuske 和其他一些无意伤害你的隐私的重用 Tuske 私钥的软件会自动处理这些。&lt;br&gt;如果你也在使用一个重用私钥的 Tuske 拷贝，而且这个拷贝没有包含这样的保护，你的交易仍然可以在那个拷贝上得到保护，但你需要手动将环输入到此页中，以便你能在后续安全地花费你的 Tuske。&lt;br&gt;如果你没有使用一个不附带此安全特性的重用私钥的 Tuske 拷贝的话，那么你什么都不用做，一切都是自动的。&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>这个环签名已在密钥重用的Tuske链上使用过, 因此重复使用同一个环签名可以避免隐私问题. </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>输入Tuske地址 (例如: 44AFFq5kSiGBoZ...)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>请访问tuske.network了解详情</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>为了能够与Tuske网络通信，您的钱包需要连接到一个Tuske节点。为了最好的隐私，建议运行您自己的节点。</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>除此之外，你还可以指定一个引导节点来快速的使用Tuske。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>如果这是您第一次使用Tuske，请选择此选项。</translation>
    </message>
    <message>
        <location filename="../wizard/WizardHome.qml" line="104"/>
    ...
    <message>
        ...
        <translation>连接您的硬件钱包，以创建一个新Tuske钱包。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>该模式非常适合管理少量的Tuske。您可以访问用于创建和管理交易的基本功能。它会自动连接到Tuske网络，所以您可以立即开始使用Tuske。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>这个地址接收了 %1 个Tuske, 并通过 %2 次的确认. </translation>
    </message>
    <message>
        <location filename="../main.qml" line="1066"/>
        <source>Good signature</source>
    ...
    <message>
        ...
        <translation>这个地址将收到 %1 个tuske币, 但这笔交易尚未被矿工确认</translation>
    </message>
    <message>
