...
; See LICENSE
#define GuiVersion GetFileVersion("bin\tuske-wallet-gui.exe")
...
DefaultDirName={commonpf}\Tuske GUI Wallet
DefaultGroupName=Tuske GUI Wallet
UninstallDisplayIcon={app}\tuske-wallet-gui.exe
...
AppPublisherURL=https://tuske.network
TimeStampsInUTC=yes
...
Source: "bin\tuske-wallet-gui.exe"; DestDir: "{app}"; Flags: ignoreversion
...
; Filename: "{app}\tuske-wallet-gui.exe"; Description: "Run GUI Wallet now"; Flags: postinstall nowait skipifsilent
...
Name: "{group}\GUI Wallet"; Filename: "{app}\tuske-wallet-gui.exe";
Name: "{group}\GUI Wallet Guide"; Filename: "{app}\monero-gui-wallet-guide.pdf"; IconFilename: "{app}\tuske-wallet-gui.exe"
...
Name: "{group}\Utilities\x (Check GUI Wallet Log)"; Filename: "Notepad"; Parameters: """{userappdata}\tuske-wallet-gui\tuske-wallet-gui.log"""
...
Name: "{commondesktop}\GUI Wallet"; Filename: "{app}\tuske-wallet-gui.exe"; Tasks: desktopicon
...
Root: HKCR; Subkey: "monero\DefaultIcon"; ValueType: "string"; ValueData: "{app}\tuske-wallet-gui.exe,0"
Root: HKCR; Subkey: "monero\shell\open\command"; ValueType: "string"; ValueData: """{app}\tuske-wallet-gui.exe"" ""%1"""
...
Root: HKCR; Subkey: "moneroseed\DefaultIcon"; ValueType: "string"; ValueData: "{app}\tuske-wallet-gui.exe,0"
Root: HKCR; Subkey: "moneroseed\shell\open\command"; ValueType: "string"; ValueData: """{app}\tuske-wallet-gui.exe"" ""%1"""
